...
public class CustomerVenueViewActivity extends AbstractActivity implements MapViewPager.Callback {

    private ArrayList<LocationModel> locationModelArrayList ;
    private ImageView category, search, cu_wallet, switch_search ;
    private EditText search_google_map ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        category.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                GD.select_pos = 0;
                Intent backintent = new Intent(getApplicationContext(), CategoryScreen.class);
