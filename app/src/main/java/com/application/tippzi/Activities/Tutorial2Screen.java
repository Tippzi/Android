...
public class Tutorial2Screen extends AbstractActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_toturial2);

        TextView skip = findViewById(R.id.btn_skip_tutorial2);
        ...
        RelativeLayout background = findViewById(R.id.activity_tutorial2);
        background.setOnTouchListener(new OnSwipeTouchListener(Tutorial2Screen.this){
